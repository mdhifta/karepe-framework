    ...
    <main class="container">
      ...
      <div class="container-sm bg-light p-6 mt-3 rounded">
            <div class="row">
                ...
                <div class="col-md align-self-center">
                    <h4 class="text-primary"><?= strtoupper('Selamat Datang di Karepe FRAMEWORK'); ?></h4>
                    <hr>
      ...
      <div class="container mt-3">
          ...
          <p class="text-justify">
            Karepe adalah struktur dari Bebebas Native yang ada di karepe framework. Untuk menjalankan struktur ini, anda bisa melihat contoh 
